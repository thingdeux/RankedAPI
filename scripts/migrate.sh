...
DJANGO_SETTINGS_MODULE=src.Ranked.settings ./manage.py migrate

#DJANGO_SETTINGS_MODULE=src.Ranked.settings SECRET_KEY=REPLACEMEL8r JWT_SECRET_KEY=REPLACEMEL8r ./manage.py loaddata src/Ranked/fixtures/0.json
