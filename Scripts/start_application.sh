...
DJANGO_SETTINGS_MODULE=Ranked.settings /home/ec2-user/src/ranked/manage.py collectstatic supervisord -c /home/ec2-user/www/project/supervisor/default.conf
