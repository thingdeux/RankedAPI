...
echo yes | DJANGO_SETTINGS_MODULE=Ranked.settings /home/ec2-user/src/ranked/manage.py collectstatic
DJANGO_SETTINGS_MODULE=src.Ranked.settings /home/ec2-user/src/ranked/manage.py collectstatic supervisord -c /home/ec2-user/src/ranked/Conf/supervisor/default.conf
